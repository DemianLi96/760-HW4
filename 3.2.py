...
class ThreeLayerNet:
    def __init__(self):
        ...
        self.lr = 5e-2
        self.params = {}
        self.params['w1'] = np.random.randn(300, 784) * np.sqrt(2 / 784)
        self.params['w2'] = np.random.randn(200, 300) * np.sqrt(2 / 300)
        self.params['w3'] = np.random.randn(10, 200) * np.sqrt(2 / 150)
